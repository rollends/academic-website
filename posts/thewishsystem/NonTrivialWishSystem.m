...
sol = simulannealbnd(@(a) CostFunction(a(1), a(2)), [0.2324 25/100], [1e-4 1e-4], [1 - 1e-4, 1 - 1e-4], options)

%% Final Distribution
dist = FinalDistributionJump(sol(1), sol(2));
...
function cost = CostFunction(arvalue, auvalue)
    dist = FinalDistributionJump(arvalue, auvalue);
    cost = 0;
